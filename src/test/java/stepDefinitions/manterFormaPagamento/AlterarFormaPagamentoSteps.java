...
public class AlterarFormaPagamentoSteps extends BasePage {
	...
	public void visualizar_o_título(DataTable formData) throws Throwable {
		List<List<String>> data = formData.raw();
		alterarFormaPagamento.selecionarTitulo(data.get(0).get(1));
	}
	...
	public void alterar() throws Throwable {
		alterarFormaPagamento.alterarContaVinculada();
	}
