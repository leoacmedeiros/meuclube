...
public class MenuPage extends BasePage {
	...
	public static final String MAIS_VANTAGENS = "//span[@class='vsm-title'][contains(text(),'Mais Vantagens')]";
	...
	public void maisVantagens() {
		clicarBotao(By.xpath(ABRIRMENU));
		scrollElementoClicar(By.xpath(MAIS_VANTAGENS));
	}
