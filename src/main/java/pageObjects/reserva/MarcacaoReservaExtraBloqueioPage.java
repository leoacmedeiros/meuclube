...
public class MarcacaoReservaExtraBloqueioPage extends BasePage {
	...
	public void selecionarVerQuartos(String situacaoHotel) {
		clicarElementoScrollVisivel(By.xpath("(//div[@class='layout pb-4 px-3 row']//span[contains(text(),'"+situacaoHotel+"')]//parent::div//parent::div//parent::div//parent::div//parent::div//parent::div//div[contains(text(),'Ver quartos')])[1]"));
	}
