...
public class AdquirirDiariaAvulsaReservaPage extends BasePage {
	...
	public void selecionarDataDispHotel() {
		...
		for (WebElement element : elementos) {
	        ...
	        String selecionarDiaInicio = numDia.get(14).getText();
	        String selecionarDiaFim = numDia.get(15).getText();
	...
	public void informarQtdDiariasAvulsas(String qtdDias) {
		escrever(By.xpath("(//div[contains(text(),'Executivo 3')]//parent::div//parent::div//input)[2]"), qtdDias);
		...
		sleep(2);
		Assert.assertEquals(obterTexto(By.xpath("//div[contains(text(),'Limite')]//parent::div//div[@class='font-weight-medium orange--text']")), obterTexto(By.xpath("//div[contains(text(),'Diárias Avulsas')]//parent::div//div[@class='black--text font-weight-medium']")));
